...
export function ChatSidebar({ tpe, robotId }: ChatSidebarProps) {
  ...
  return (
    <aside
      className={`relative z-[100] flex shrink-0 flex-col border-r border-zinc-200 bg-zinc-50/80 transition-[width] duration-200 ease-in-out dark:border-zinc-800 dark:bg-zinc-900/50 ${
    ...
    >
      <div className="flex h-full min-w-0 flex-col">
        ...
        <button
          ...
          className="absolute right-0 top-1/2 z-[110] flex size-8 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full border border-zinc-200 bg-zinc-50 text-zinc-600 shadow-sm hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-700"
